...
def calculate_cube_volume(first_side: float, second_side:float , third_side:float) -> float:
    """
    Обчислює периметр трикутнки.
    
    Args:
        first_side: довжина першої сторони
        second_side: довжина другої сторони
        third_side: довжина третьої сторони
    Returns:
        float: периметр трикутнка
    """
    return first_side+second_side+third_side

def calculate_triangle_perimeter(side: float) -> float:
    """
    Обчислює об'єм куба.
